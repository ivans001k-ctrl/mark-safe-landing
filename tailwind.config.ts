...
export default {
  ...
  theme: {
  	...
  	extend: {
  		...
  		boxShadow: {
  			'glass': '0 8px 32px rgba(76, 29, 149, 0.1)',
  			'glass-lg': '0 20px 60px rgba(76, 29, 149, 0.12)',
  			'button': '0 4px 20px rgba(250, 204, 21, 0.4)',
  			'button-hover': '0 8px 30px rgba(250, 204, 21, 0.5)',
